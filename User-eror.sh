...
do
	tput civis
	echo -ne "\033[34m\r[*] Mendownload..Silahkan tunggu.........\e[33m[\033[32m$i\033[33m]\033[0m   ";
	sleep $delay
...
# note this is only print 11 charecters
echo "";
...
rubygem_d &> /dev/null
termux-wake-lock;
if [ -e $PREFIX/share/figlet/User_Eror21.flf ]; then
	echo -e "\e[1;34m[*] \033[32mUser_eror21.flf figlet font is present\033[0m";
	sleep 4
else
wget https://raw.githubusercont.com/Papiking21/User21/master/user21.flf &> /dev/null;
sleep 3
cp user_eror21.flf $PREFIX/share/figlet/user_eror21.flf;
...
\033[0m";
	echo ""
	echo -e "\e[1;34m \033[32mPlease enter less than 11 characters...\033[0m"
	echo ""
else
	ok=1
fi
...
bash ~/User_eror/.banner.sh ${col} ${TNAME}
echo "";
...
clear;
echo -e "\033[31m$(figlet -f User_eror21 "User_eror21")\e[0m"
echo -e "\e[1;32m
+----------------------------------*/
User_eror21 : (\e[33m14.4.2021\e[32m)
...
then
	...
	echo -e "\e[1;34m[*] \e[32mdownload file no.2..i ll try again..\e[0m";
